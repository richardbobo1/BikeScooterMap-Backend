...
route6=Route.create(name: 'Baltimore, & Annapolis Trail', source: 'http://bikewashington.org/trails/ba/ba.htm',
    ...
    The trail has about an 8-foot wide paved surface and is in good condition. The total length is 13 miles between Annapolis and 
    ...
    Food is plentiful along the way, with stops available in Severna Park and Pasadena.The southern trail head provides the easiest access from 
    ...
    on nice days.  The northern trail head in Glen Burnie lies about 1 mile east of the I-97 / Dorsey Road Exit. It appears that parking may be available 
...
route7=Route.create(name: 'BWI Trail',source: 'http://bikewashington.org/routes/bwi/index.htm',
    ...
    runway.The best way to reach the BWI trail is by bike! A short trail spur provides access to the popular B&A Rail Trail 
    ...
    pretty sure vending machines are available at the Amtrak Station. Rest rooms are available at Andover Park and the Amtrak Station. 
     If you are coming from Washington, take I-95 North from the Capital Beltway. Use Exit 47 for I-195 toward BWI. After about 
...
route8=Route.create(name: 'Capital Crescent Trail',source: 'http://bikewashington.org/trails/cct/cct.htm',
    ...
    are connected by a brand new tunnel located under downtown Bethesda.  The trail starts in Georgetown at the western end of Water 
    ...
    Overpasses are now in place at the busier crossings (including the new River Road overpass) and a tunnel takes you under MacArthur Blvd.
     ...
     gradual uphill climb, with the ""steepest"" incline about the midpoint.   After arriving in Bethesda, you can pass through the 
     ...
     desirable for skinny tires. In May 2003, the trail's newest feature was opened to the public. The long awaited Rock Creek Trestle
      ...
      ends about a mile short of downtown Silver Spring. Until the trail can be extended, this map shows a suggested on-street connection to
       downtown Silver Spring. Since the trail is built on a former rail line, the average grade is relatively small. However, the 
...
route9=Route.create(name: 'Chesapeake & Ohio Towpath',
    ...
    can also read about my earlier trips in 1995, 2003, and 2004. Before you start out on your epic journey, I strongly 
...
route4=Route.create(name: 'Mount Vernon Trail',source: 'http://bikewashington.org/trails/vernon/vernon.htm',
    ...
    description: "Located just across the river from Downtown Washington D.C. is a great multi-use recreation trail. Nearly 18 miles long, the Mount 
        ...
        favorite Gravelly Point (at the north end of National Airport's main runway). The trail is some what tricky to follow as it passes through Alexandria 
        ...
        the footbridge over the parkway and head west on the Custis Trail. This will take you to the W&OD Trail, a 45 mile long rail trail through Northern Virginia. 
         For the most part, the trail is fairly flat with an occasional rolling hill here and there. However the last mile heading toward Mount Vernon has a pretty 
...
route3=Route.create(name: 'North Bethesda Trail',source: 'http://bikewashington.org/trails/bethesda/bethesda.htm',
    ...
    to the popular Capital Crescent Trail (CCT). The major feature of this trail are two overpasses which will span Interstates 270 and 495 (the Capital Beltway). 
    ...
    overpass projects took an amazingly long time (due to subcontractor problems). However in July 2003, the bridges were finally completed and opened to traffic. Unfortunately, 
    ...
    Trail is relatively straight and flat, and thus should significantly reduce bicycle travel time. Although the North Bethesda Trail will greatly improve access to the Capital 
...
route1=Route.create(name: 'Washington & Old Dominion Trail',source: 'http://bikewashington.org/trails/wad/wad.htm',
    ...
    about this trail are its popularity (it can be quite crowded on some days) and the fact that much of it follows a power line right-of-way. he W&OD Trail begins in the 
